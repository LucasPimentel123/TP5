...
/**
 * classe para a janela de edição do cliente na interface gráfica
 * 
...
public class ViewClienteEdita extends JFrame {
	...
	/**
	 * Mostra todos os dados do cliente em campos textuais para que o usuário possa
	 * editá-los
	 * 
	 * @param produtos     lista de produtos
	 * @param clientes     lista de clientes
	 * @param vendas       lista de vendas
	 * @param clienteAtual cliente buscado pelo usuário
	 */
	...
	public ViewClienteEdita(List<Produto> produtos, List<Cliente> clientes, List<Venda> vendas, Cliente clienteAtual) {
		...
		botaoAtualiza.addActionListener(new ActionListener() {
			...
			/**
			 * define os dados dos campos textuais como os novos dados do Cliente
			 */
