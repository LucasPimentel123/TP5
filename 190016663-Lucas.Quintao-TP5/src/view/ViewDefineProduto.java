...
/**
 * classe para a janela de definição de qual produto será cadastrado
 * 
...
public class ViewDefineProduto extends JFrame {
	...
	/**
	 * Checkboxes com as varias classes de produtos para o cliente escolher qual
	 * tipo de produto deseja cadastrar
	 * 
	 * @param produtos
	 * @param clientes
	 * @param vendas
	...
	public ViewDefineProduto(List<Produto> produtos, List<Cliente> clientes, List<Venda> vendas) {
		...
		botaoConfirma.addActionListener(new ActionListener() {
			...
			/**
			 * abre a tela de cadastro da classe de produto escolhida pelo usuário
			 */
