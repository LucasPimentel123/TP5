...
/**
 * classe para a janela de produto na interface gráfica
 * 
...
public class ViewProduto extends JFrame {
	...
	public ViewProduto(List<Produto> produtos, List<Cliente> clientes, List<Venda> vendas) {
		...
		// chama a tela de cadastro de novo produto
		...
		botaoBusca.addActionListener(new ActionListener() {
			...
			/**
			 * Caso o nome do produto digitado pelo usuário corresponda a um produto
			 * cadastrado, abre a tela de busca do produto, caso contrário mostra mensagem
			 * de erro
			 */
