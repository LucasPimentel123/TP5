...
/**
 * Classe main para a chamada da interface gráfica, declaração de listas e de
...
public class Main {
	...
	public static void main(String[] args) {
		...
		c3 = new Cliente("pedro", cel, (long) 826733421, "tradicional", end2);
		...
		choc2 = new ChocolateEmPo(20.99, 1000, "Chocolate em po amargo", "pequeno", "cremoso", "amargo");
